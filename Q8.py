...
# 
# Numbers never get smaller. This might sound odd except that is the only thing that consistently happens in the Universe, things get older. There are plenty of particles that are identical to each other. By using a function called reduce() on this class, one can see if two different sets of numbers are equivalent ($8 - 3 == 7 - 2 = +5
